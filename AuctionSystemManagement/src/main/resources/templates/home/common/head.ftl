...
<div class="head">
    <div class="contain">
        <div class="head_top">
            ...
            <div class="logo_font"style="margin-top: 10px;">中兴竞拍</div>
                ...
                <#if zte_home ??>
                    <div class="admin_right" style="float: right;line-height: 0px;width: 300px;">
                          <div class="head_user_icon" style="width: 34px;height: 34px;float: left;margin-top: 18px;padding-left: 17px;">
                              <#if zte_home.headPic??>
                                  <#if zte_home.headPic?length gt 0>
                                      <img style="height:34px;width:34px" src="/photo/view?filename=${zte_home.headPic}"/>
                                   <#else>
                          ...
                          <div class="head_user head_personal_user">
                              ${zte_home.mobile?substring(0,3)}***${zte_home.mobile?substring(8)}
                          </div>
