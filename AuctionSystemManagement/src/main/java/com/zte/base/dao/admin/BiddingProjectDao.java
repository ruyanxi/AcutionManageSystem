...
import com.zte.base.bean.ProjectStatus;
import com.zte.base.entity.admin.ApprovalRecord;
...
public interface BiddingProjectDao extends JpaRepository<BiddingProject, Long>,JpaSpecificationExecutor<BiddingProject> {
	...
	@Query(value = "update zte_bidding_project set project_status=:status where id=:id",nativeQuery = true)
	...
	@Transactional
	@Modifying(clearAutomatically = true)
	@Query(value = "update zte_bidding_project set project_status=:#{#approvalRecord.projectStatus.code},reason=:#{#approvalRecord.reason} where id=:#{#approvalRecord.biddingProject.id}",nativeQuery = true)
	...
	@Transactional
	@Modifying(clearAutomatically = true)
	@Query(value = "update zte_bidding_project set views_number=:viewNumber where id=:id",nativeQuery = true)
	...
	@Transactional
	@Modifying(clearAutomatically = true)
	@Query(value = "update zte_bidding_project set current_price=:currentPrice where id=:id",nativeQuery = true)
	...
	@Transactional
	@Modifying(clearAutomatically = true)
	@Query(value = "update zte_bidding_project set auction_times=:auctionTimes where id=:id",nativeQuery = true)
	...
	@Transactional
	@Modifying(clearAutomatically = true)
	@Query(value = "update zte_bidding_project set applicants_number=:applicantsNumber where id=:id",nativeQuery = true)
	...
	@Transactional
	@Modifying(clearAutomatically = true)
	@Query(value = "update zte_bidding_project set bidding_end_time=:biddingEndTime where id=:id",nativeQuery = true)
