package com.zte.base.schedule.home;

import com.zte.base.bean.EarnestMoneyStatus;
import com.zte.base.bean.ProjectStatus;
import com.zte.base.bean.RemindType;
import com.zte.base.entity.common.BiddingProject;
import com.zte.base.entity.home.BiddingApply;
import com.zte.base.entity.home.BiddingRecord;
import com.zte.base.entity.home.BiddingRemind;
import com.zte.base.service.admin.BiddingProjectService;
import com.zte.base.service.home.BiddingApplyService;
import com.zte.base.service.home.BiddingRecordService;
import com.zte.base.service.home.BiddingRemindService;
import com.zte.base.service.home.HomeUserService;
import com.zte.base.util.SendEmailUtil;
...
public class ProjectSchedule {
    ...
    @Value("${zte.email.address}")
    private String sourceEmail; //发件人邮箱

    @Value("${zte.email.authorization-code}")
    ...
    public SendEmailUtil sendEmailUtil(String email, String title) throws Exception {
        ...
        sendEmailUtil.sendMsg("中兴竞拍：你设置提醒的项目:<" + title + ">已开始竞拍。");//发送信息
