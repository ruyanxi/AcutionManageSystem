package com.zte.base.service.admin;
import java.io.File;
...
import com.zte.base.dao.admin.DatabaseBakDao;
import com.zte.base.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	@Value("${zte.database.backup.dir}")
	private String backUpDir;
	@Value("${zte.database.backup.username}")
	private String dbUsername;
	@Value("${zte.database.backup.password}")
	private String dbPwd;
	@Value("${zte.database.backup.database.name}")
